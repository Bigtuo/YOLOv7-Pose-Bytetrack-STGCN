...
from stgcn.Models import TwoStreamSpatialTemporalGraph
from stgcn.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 weight_file='./stgcn/tsstg-model.pth',
                 device='cuda'):
